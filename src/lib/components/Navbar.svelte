...
<nav class="fixed top-0 left-0 w-full z-50 transition-all duration-300 {isScrolled ? 'bg-black/80 backdrop-blur-md border-b border-white/10' : 'bg-transparent'} text-white">
	<div class="max-w-[1400px] mx-auto px-6 h-20 flex items-center justify-between">
		<!-- Logo -->
		<a href="/" class="text-2xl font-serif tracking-tight font-medium">M45</a>
		...
		<div class="hidden lg:flex items-center gap-6">
			...
			<a href="#" class="bg-[oklch(0.696_0.17_162.48)] hover:bg-[oklch(0.596_0.145_163.225)] text-white px-5 py-2.5 rounded-full text-sm font-medium transition-colors">
				Request demo
			</a>
		</div>
	...
	{#if isMenuOpen}
		<div class="lg:hidden bg-black absolute top-20 left-0 w-full h-[calc(100vh-80px)] p-6 flex flex-col gap-6 overflow-y-auto border-t border-white/10">
			<a href="#" class="text-lg font-medium text-gray-300 hover:text-white">Platform</a>
			...
			<a href="#" class="text-lg font-medium text-gray-300 hover:text-white">Resources</a>
			<a href="#" class="text-lg font-medium text-gray-300 hover:text-white">Customers</a>
			...
			<a href="#" class="bg-[oklch(0.696_0.17_162.48)] text-white px-5 py-3 rounded-full text-center font-medium">
				Request demo
			</a>
		</div>
	{/if}
