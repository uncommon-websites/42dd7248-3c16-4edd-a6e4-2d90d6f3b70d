...
<section class="relative pt-32 pb-20 overflow-hidden bg-black text-white">
	<div class="max-w-[1400px] mx-auto px-6">
		<div class="max-w-4xl">
			<h1 class="text-6xl md:text-7xl lg:text-[5.5rem] leading-[1.1] font-serif font-normal tracking-tight mb-8">
				Capture <span class="italic font-light font-serif">tribal knowledge</span><br />
				instantly with AI
			</h1>

			<p class="text-xl text-gray-400 max-w-2xl mb-10 leading-relaxed font-light font-sans">
				AI-powered visual documentation that surfaces critical insights across your cloud infrastructure—giving security teams unified visibility when it matters most.
			</p>

			<div class="flex flex-wrap gap-4 mb-20">
				<button class="bg-[oklch(0.696_0.17_162.48)] hover:bg-[oklch(0.596_0.145_163.225)] text-white px-8 py-4 rounded-full font-medium transition-colors text-base">
					Request demo
				</button>
    ...
    <div class="max-w-[1400px] mx-auto px-6 mt-20">
        <p class="text-center text-sm text-gray-500 mb-8 uppercase tracking-wider">Trusted by enterprise security teams</p>
        <div class="flex flex-wrap justify-center md:justify-between items-center gap-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            <span class="text-xl font-bold font-sans">CrowdStrike</span>
            <span class="text-xl font-bold font-serif">Palo Alto</span>
            <span class="text-xl font-bold font-sans tracking-widest">OKTA</span>
            <span class="text-xl font-bold font-serif">Datadog</span>
            <span class="text-xl font-bold font-sans">Cloudflare</span>
            <span class="text-xl font-bold font-sans">Splunk</span>
        </div>
    </div>
</section>
